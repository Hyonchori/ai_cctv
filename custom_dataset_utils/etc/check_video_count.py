...
def parse_opt():
    ...
    source = "/home/daton/Downloads/videos/trespassing original video.mp4"
    #source = "/home/daton/PycharmProjects/pythonProject/ai_cctv/runs/inference/exp40/video.mp4"
    #source = "/dev/video100"
